      ...
      {handleSearch && (
        <div className="relative w-full my-4">
          <input
            ...
            className="block w-full px-4 py-2 text-gray-900 border border-gray-200 rounded-md dark:border-gray-900  focus:border-y-stone-600 dark:bg-gray-800 dark:text-gray-100"
          />
          <svg
