...
export default function Snippets({
  ...
  return (
    <Container
      title="Code Snippets – Ved Gupta"
      description="A collection of code snippets – including serverless functions, Node.js scripts, and Python Scripts."
    >
...
export async function getStaticProps({ preview = false }) {
  ...
  return { props: { snippets }, revalidate: 120 };
}
